...
class account:
    ...
    # def buy(self):
    #     self.volume += self.account/self.stock_data[self.trade_day]
    #     self.account = 0
    #     self.trade_day += 1
    
    # def sell(self):
    #     self.account += self.volume * self.stock_data[self.trade_day]
    #     self.volume = 0
    #     self.trade_day += 1
    ...
    # def settlement(self):
    #     return self.account + self.volume * self.stock_data[self.trade_day]
    
    # def buy_and_hold(self):
    #     return self.init_volume * self.stock_data[self.trade_day]
